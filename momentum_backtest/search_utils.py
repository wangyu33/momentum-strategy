...
def add_notify_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
...
def should_send_notify(args: argparse.Namespace) -> bool:
...
def notify_best_candidate(
    ...
    *,
    ...
    if not should_send_notify(args) or notify_df.empty:
        return False, None
    ...
    try:
        ...
        if suppress_exceptions:
            return False, f"{strategy_name}: {exc}"
        raise
