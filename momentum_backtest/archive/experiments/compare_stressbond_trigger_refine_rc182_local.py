...
OUTPUT_DIR = Path("momentum_backtest/output/research/archive_flat/compare_stressbond_trigger_refine_rc182_local")
    ...
    for ratio_cut in ratio_candidates:
        for breadth_cut in breadth_candidates:
            for risk_cap in risk_cap_candidates:
                ...
                strategy = (
                    f"{DEFAULT_STRATEGY_NAME}__trf3"
