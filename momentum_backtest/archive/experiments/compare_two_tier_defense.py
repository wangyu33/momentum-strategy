#!/usr/bin/env python3
"""Compare compact two-tier defensive overlays around the current 10Y treasury winner."""
...
OUTPUT_DIR = Path("momentum_backtest/output/research/archive_flat/compare_two_tier_defense")
...
def apply_two_tier_overlay(
    ...
    extreme_only_mask = extreme_mask
    ...
    if extreme_only_mask.any():
        extreme_scale_mask = extreme_only_mask & (row_risk_weight > extreme_cap)
                    ...
                    for extreme_breadth_cut in extreme_breadth_candidates:
                        ...
                        for extreme_cap in extreme_cap_candidates:
                            ...
                            for extreme_short_ratio_cut in extreme_short_ratio_candidates:
                                ...
                                summary["weak_ratio_cut"] = weak_ratio_cut
                                summary["weak_breadth_cut"] = weak_breadth_cut
                                summary["weak_cap"] = weak_cap
                                summary["extreme_ratio_cut"] = extreme_ratio_cut
                                summary["extreme_breadth_cut"] = extreme_breadth_cut
                                summary["extreme_cap"] = extreme_cap
                                summary["extreme_short_ratio_cut"] = extreme_short_ratio_cut
                                rows.append(summary)
